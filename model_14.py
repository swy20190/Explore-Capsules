...
# No.1, pretrained vgg-19
class VggExtractor(nn.Module):
    def __init__(self, train=False):
        super(VggExtractor, self).__init__()

# Choose the first 18 layers of vgg19
...
# from begin to end (0-9) layer of vgg-19, the weights are freezed
...
# No.2, get capsules from pretrained vgg19
class FeatureExtractor(nn.Module):
    def __init__(self):
        ...
        self.capsules = nn.ModuleList([
            nn.Sequential(
                # in channels 256, out channels 64
